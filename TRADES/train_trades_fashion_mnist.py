...
# Added from https://docs.microsoft.com/en-us/learn/modules/train-local-model-with-azure-mls/3-script-parameters
...
def main():
    ...
    # joblib.dump(value=model, filename='outputs/model.pt')
    ...
    # Run Auto Attack, mostly use example from eval.py
    ################################################
